...
gcc -O0 -o $OUT_PATH/check_chunk_and_debug $TEST_PATH/check_chunk_and_debug.c $(ls $SRC_PATH/*.c | grep -v 'vm.c') $MOCK_LIBS $TEST_FLAGS && $OUT_PATH/check_chunk_and_debug
...
gcc -DTESTING -O0 -o $OUT_PATH/check_compiler $TEST_PATH/check_compiler.c $(ls $SRC_PATH/*.c | grep -v 'vm.c') $MOCK_LIBS $TEST_FLAGS && $OUT_PATH/check_compiler
